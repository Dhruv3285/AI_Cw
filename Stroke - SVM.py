...
plt.subplot(321)
plt.scatter(df['age'],df['bmi'], c=y1, s=50)

plt.subplot(322)
plt.scatter(df['avg_glucose_level'],df['heart_disease'], c=y1, s=50)

plt.subplot(323)
plt.scatter(df['age'],df['avg_glucose_level'], c=y1, s=50)

plt.subplot(324)
plt.scatter(df['heart_disease'],df['age'], c=y1, s=50)
