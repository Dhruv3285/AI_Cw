...
filename_read = os.path.join(path, "Company Bankruptcy Prediction.csv")
...
plt.subplot(321)
plt.scatter(df[' Quick Assets/Current Liability'],df[' Current Assets/Total Assets'], c=y1, s=50)

plt.subplot(322)
plt.scatter(df[' Quick Assets/Total Assets'],df[' Cash/Total Assets'], c=y1, s=50)

plt.subplot(323)
plt.scatter(df[' Quick Assets/Total Assets'],df[' Quick Assets/Current Liability'], c=y1, s=50)

plt.subplot(324)
plt.scatter(df[' Current Assets/Total Assets'],df[' Cash/Total Assets'], c=y1, s=50)
